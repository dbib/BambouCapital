      ...
      <div className="admin-reset-pass">
        <div className="admin-reset-pass-cont">
          <div className="admin-reset-text-cont">
            <p>
              Vous avez oublier votre mot de passe? Vous pouver le regenerer ici
            </p>
            <p>
              Un nouveau mot de passe vous sera envoyer! Vous pourriez ensuite
              la change et choisir un mot de passe de votre choix une fois
              connecteee
            </p>
          </div>
